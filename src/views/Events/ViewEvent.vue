        ...
        <v-row class="pa-0">
          <v-col md="3" class>
            <div
              ...
              "
            >
              <p class="google-font" style="font-size: 180%">
                {{ eventInfo.name }}
              </p>
              ...
              <p class="google-font my-0">
                <b>Venue: </b>
                <a :href="eventInfo.venue.googlemapsurl">{{
          ...
          <v-col class="pa-3" md="9">
            ...
            >
              <v-img
                :src="
                  eventInfo.image.length > 0
                    ? eventInfo.image
                    : require('@/assets/img/dontremove/eventbanner.jpg')
                "
                width="100%"
                cover
                ...
                <v-container>
                        ...
                        <v-row v-if="eventInfo.speakers.length > 0">
                          ...
                          >
                            <div v-for="(itemp, j) in speakersInfo" :key="j">
                              <div
                                v-if="item == itemp.id"
                                class="lightModeCard pa-3 text-center"
                              >
                                <v-avatar size="80">
                                  <img
                                    :src="
                                      itemp.image.length > 0
                                        ? itemp.image
                      ...
                      <v-container class="pa-0">
                        <v-row v-if="eventInfo.team.length > 0">
                          <v-col cols="12" class="ma-0 py-1">
                            <span class="font-weight-bold google-font"
                              >Core Team:</span
                            >
                  ...
                  <v-row>
                    <v-col>
                      ...
                      <p
                        class="google-font"
                        v-if="eventInfo.agenda.length == 0"
                      >
                        No Agenda
                      </p>
                      <dir v-else>
