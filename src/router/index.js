...
const routes = [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "partners-details" */ '@/views/Partners/ViewPartner'
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    name: 'Team-Details',
    component: () =>
      import(/* webpackChunkName: "team-details" */ '@/views/Team/ViewTeam'),
    meta: {
      requiresAuth: true,
      title: 'Team Details',
      bottomVisible: true,
  ...
  },
  {
    ...
    name: 'Speakers',
    component: () =>
      import(/* webpackChunkName: "speakers" */ '@/views/Speakers'),
    meta: {
      requiresAuth: true,
      title: 'Speakers',
      bottomVisible: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "speakers-details" */ '@/views/Speakers/ViewSpeaker'
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "event-details" */ '@/views/Events/ViewEvent'
      ),
    meta: {
      requiresAuth: true,
      title: 'Event Details',
  ...
  },
  {
    ...
    name: 'connect',
    component: () =>
      import(/* webpackChunkName: "notifications" */ '@/views/Connect'),
    meta: {
      requiresAuth: true,
      title: 'Connect',
      bottomVisible: false,
  ...
  },
  {
    ...
    name: 'profile',
    component: () =>
      import(/* webpackChunkName: "roles" */ '@/views/Profile/Profile'),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    name: 'EmailView',
    component: () =>
      import(/* webpackChunkName: "notifications" */ '@/views/Email/ViewEmail'),
    meta: {
      requiresAuth: true,
      title: 'Email',
      bottomVisible: true,
